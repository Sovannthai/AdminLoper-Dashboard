!function (t, e) {
    ...
    r.prototype = {
        ...
        actualizeOptions: function () {
            return d.attr(this.element, this.options.namespace, this.domOptions),
    ...
    c.prototype = {
        validate: function (t, e) {
            ...
            if (this.validateDate && i._isDateInput())
                return arguments[0] = d.parse.date(arguments[0]),
        ...
        parseRequirements: function (t, e) {
            ...
            if (Array.isArray(i)) {
                for (var r = function (t, e) {
                    ...
                    if (r.length !== e)
                        throw "Requirement has " + r.length + " values when " + e + " are needed";
                    return r
    ...
    a.prototype = {
        ...
        addCatalog: function (t, e, i) {
            return "object" === n(e) && (this.catalog[t] = e),
        ...
        removeValidator: function (t) {
            return this.validators[t] || d.warn('Validator "' + t + '" is not defined.'),
    ...
    v.Form = {
        ...
        v.Field = {
            ...
            _actualizeTriggers: function () {
                ...
                i.off(".Parsley"),
                    this._failedOnce ? i.on(d.namespaceEvents(this.options.triggerAfterFailure, "Parsley"), function () {
                        e._validateIfNeeded()
                ...
                this._withoutReactualizingFormOptions(function () {
                    n.$element.find(n.options.inputs).not(n.options.excluded).not("[".concat(n.options.namespace, "excluded=true]")).each(function (t, e) {
                        ...
                        if ("Field" === i.__class__ || "FieldMultiple" === i.__class__) {
                            ...
                            void 0 === n.fieldsMappedById[r] && (n.fieldsMappedById[r] = i,
                                n.fields.push(i))
                        }
                    }),
    ...
    w.prototype = {
        ...
        _validateConstraint: function (t, e) {
            var i = this
                , r = e.validate(t, this);
            return !1 === r && (r = h.Deferred().reject()),
    ...
    function A(t, e, i) {
        ...
        if (r)
            return void 0 !== i && r.parent === window.Parsley && (r.parent = i,
    ...
    A.prototype = {
        init: function (t) {
            return this.__class__ = "Parsley",
                ...
                "FORM" === this.element.nodeName || d.checkAttr(this.element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        },
        isMultiple: function () {
            var t = d.getType(this.element);
        ...
        handleMultiple: function () {
            ...
            if (!this.options.multiple)
                return d.warn("To be bound by Parsley, a radio, a checkbox and a multiple select input must have either a name or a multiple option.", this.$element),
                    this;
        ...
        (new function () {
            ...
            l(this, {
                ...
                misbehaves: function (t) {
                    r.isNativeEvent(t) && (r.behavesOk(t),
