...
var FullCalendar = function (e) {
    ...
    var pa = function (e) {
        ...
        return n(t, e),
            ...
            t.prototype.render = function () {
                this.isRendering ? this.customContentRenderId++ : this.isRendering = !0,
                    ...
                    if (!r.wasTouchScroll) {
                        if (o.dateSelection && !t.isRecentPointerDateSelect) {
                            var i = n.options.unselectAuto
                                , a = n.options.unselectCancel;
                            !i || i && V(r.downEl, a) || n.calendarApi.unselect(e)
                        }
                        o.eventSelection && !V(r.downEl, Ia.SELECTOR) && n.dispatch({
                            type: "UNSELECT_EVENT"
                        })
                    }
            ...
            t.prototype.render = function () {
                ...
                return Hr("tr", {
                    ...
                    return Hr(Ga, {
                        ...
                        date: n.date,
                        showDayNumber: t.showDayNumbers || E,
                        showWeekNumber: E,
