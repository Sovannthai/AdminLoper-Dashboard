!function (t, e, s, i) {
    ...
    o.prototype = {
        init: function () {
            ...
            n && (s.el[0].addEventListener("touchstart", o, !1),
            ...
            s.el.bind("destroy-nestable", function () {
                n && (s.el[0].removeEventListener("touchstart", o, !1),
        ...
        _buildItem: function (e, s) {
            ...
            n.class = function (e, s) {
                ...
                "string" == typeof i && (i = [i]);
                var n = o(i);
                return n[s.itemClass] = s.itemClass,
                    t.map(n, function (t) {
                        return t
                    }).join(" ")
            }(e, s);
        ...
        asNestedSet: function () {
            function e(i, l, a) {
                var r, d, h = a + 1;
                return t(i).children(o.listNodeName).children(o.itemNodeName).length > 0 && (l++,
                    t(i).children(o.listNodeName).children(o.itemNodeName).each(function () {
                        h = e(t(this), l, h)
                    }),
                    l--),
                    r = t(i).attr("data-id"),
        ...
        toHierarchy: function (e) {
            function s(e) {
                ...
                if (o) {
                    ...
                    return t(e).children(i.listType).children(i.items).length > 0 && (n.children = [],
        ...
        toArray: function () {
            function e(n, l, a) {
                var r, d, h = a + 1;
                return n.children(s.options.listNodeName).children(s.options.itemNodeName).length > 0 && (l++,
                    n.children(s.options.listNodeName).children(s.options.itemNodeName).each(function () {
                        h = e(t(this), l, h)
                    }),
                    l--),
                    r = n.data().id,
        ...
        setParent: function (e) {
            e.is(this.options.itemNodeName) && e.children(this.options.listNodeName).length && (e.children("[data-action]").remove(),
        ...
        dragMove: function (i) {
            ...
            this.scrollTimer && clearTimeout(this.scrollTimer),
                ...
                d.dirAx && d.distAxX >= r.threshold && (d.distAxX = 0,
                    ...
                    d.distX < 0 && (this.placeEl.next(r.itemNodeName).length || (n = this.placeEl.parent(),
                        this.placeEl.closest(r.itemNodeName).after(this.placeEl),
                        n.children().length || this.unsetParent(n.parent()))));
            var f = !1;
            if (l || (this.dragEl[0].style.visibility = "hidden"),
            ...
            if (!d.dirAx || m || f) {
                if (m && r.group !== u.data("nestable-group"))
                    return;
                ...
                n = this.placeEl.parent(),
                    f ? ((o = t(s.createElement(r.listNodeName)).addClass(r.listClass)).append(this.placeEl),
